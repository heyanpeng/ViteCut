...
export type TimelineProps = {
    ...
    onClickTimeArea?: (time: number, e: ReactMouseEvent<HTMLDivElement, MouseEvent>) => boolean | undefined;
    /** 点击行回调 */
    onClickRow?: (e: ReactMouseEvent<HTMLElement, MouseEvent>, param: {
        row: TimelineRow;
        time: number;
    }) => void;
    /** 点击动作回调 */
    onClickAction?: (e: ReactMouseEvent<HTMLElement, MouseEvent>, param: {
        action: TimelineAction;
        row: TimelineRow;
        time: number;
    }) => void;
    /** 点击动作回调（触发drag时不执行） */
    onClickActionOnly?: (e: ReactMouseEvent<HTMLElement, MouseEvent>, param: {
        action: TimelineAction;
        row: TimelineRow;
        time: number;
    }) => void;
    /** 双击行回调 */
    onDoubleClickRow?: (e: ReactMouseEvent<HTMLElement, MouseEvent>, param: {
        row: TimelineRow;
        time: number;
    }) => void;
    /** 双击动作回调 */
    onDoubleClickAction?: (e: ReactMouseEvent<HTMLElement, MouseEvent>, param: {
        action: TimelineAction;
        row: TimelineRow;
        time: number;
    }) => void;
