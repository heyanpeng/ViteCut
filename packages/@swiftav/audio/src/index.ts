 ...
 *
 * 仅在浏览器环境下可用。工程数据结构由 @swiftav/project 提供，这里只关心
...
export class AudioEngine {
  ...
  private currentSources: Map<string, { source: AudioBufferSourceNode; gainNode: GainNode }> =
    new Map();
   ...
   * 解码更复杂的格式可以交给 @swiftav/media，再将解码后的 PCM 交给这里。
   */
